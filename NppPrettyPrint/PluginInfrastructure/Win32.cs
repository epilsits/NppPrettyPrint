...
namespace Kbg.NppPluginNET.PluginInfrastructure
{
    public class Win32
    {
        ...
        /// <summary>
        /// Must define LPStr marshals for string/StringBuilder for the Scintilla interface, which always uses ANSI/UTF8 strings.
        /// </summary>
        [DllImport("user32", EntryPoint = "SendMessage")]
        public static extern IntPtr SendMessageSci(IntPtr hWnd, UInt32 Msg, IntPtr wParam, [MarshalAs(UnmanagedType.LPStr)] string lParam);

        [DllImport("user32", EntryPoint = "SendMessage")]
        public static extern IntPtr SendMessageSci(IntPtr hWnd, UInt32 Msg, IntPtr wParam, [MarshalAs(UnmanagedType.LPStr)] StringBuilder lParam);
        ...
        /// at https://github.com/kbilsted/NotepadPlusPlusPluginPack.Net
        /// </summary>
        public static IntPtr SendMessage(IntPtr hWnd, uint Msg, int wParam, StringBuilder lParam)
        {
            return SendMessage(hWnd, (UInt32)Msg, new IntPtr(wParam), lParam);
        }
        ...
        /// at https://github.com/kbilsted/NotepadPlusPlusPluginPack.Net
        /// </summary>
        public static IntPtr SendMessage(IntPtr hWnd, uint Msg, int wParam, string lParam)
        {
            return SendMessage(hWnd, (UInt32)Msg, new IntPtr(wParam), lParam);
        }
